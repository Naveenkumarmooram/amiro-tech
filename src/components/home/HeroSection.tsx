...
const banners = [
  { label: 'Enterprise technology partner', title: 'Software & AI Services', subtitle: 'for Business Growth', description: 'Amiro Tech Solutions is a Bangalore-based software and AI development company. We build custom applications, enterprise AI assistants, voice agents, and workflow automation for businesses worldwide.', cta: 'Book a Strategy Call', href: '/contact?type=consultation', features: ['AI Solutions', 'Cloud Native', 'Enterprise Ready'], name: 'Overview' },
