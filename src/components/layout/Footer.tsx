...
const socialLinks = [
  { label: 'LinkedIn', href: 'https://www.linkedin.com/company/amirotechsolutions' },
  { label: 'Instagram', href: 'https://www.instagram.com/amirotechsolutions' },
]

function SocialIcon({ name }: { name: string }) {
  if (name === 'Instagram') return <svg aria-hidden="true" fill="none" viewBox="0 0 24 24"><rect x="3" y="3" width="18" height="18" rx="5"/><circle cx="12" cy="12" r="4"/><circle cx="17.5" cy="6.5" r=".75" fill="currentColor" stroke="none"/></svg>
